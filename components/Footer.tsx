...
export default function Footer() {
  ...
  if (pathname?.startsWith("/employer") || pathname?.startsWith("/worker")) {
    return null;
  }
  ...
  return (
    <footer
      id="contact"
      className="scroll-mt-20 border-t border-gray-900 bg-gray-950 pb-10 pt-16"
    >
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-12 grid grid-cols-2 gap-10 md:grid-cols-4 lg:grid-cols-5 lg:gap-12">
          <div className="col-span-2 lg:col-span-2 lg:max-w-sm">
            ...
            <p className="text-[13px] font-medium leading-relaxed text-gray-400">
              The ultimate workforce management platform for modern construction
